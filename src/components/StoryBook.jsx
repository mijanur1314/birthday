...
const storyPages = [
  ...
  { icon: "📍", title: "The first time we met", text: "প্রথম দিন যখন দেখা হয়েছিল তখন ফিলিংস কিরকম ছিল সেটা তো মনে নেই কিন্তু এখন প্রতিটা দিন প্রথম দিন মনে হয়", image: "/IMG-20250716-WA0016.jpg" },
  { icon: "🌧️", title: "A moment that tested us", text: "যখন আমার মেসেজগুলো তোমার পাপা দেখে নিয়েছিল, যখন মাসের পর মাস দেখা হয়নি যখন প্রায় ঝগড়া হতো সেই দিনগুলো কাটানোর পরেও আজ আমরা একসাথে এটা সবচেয়ে বড় আমাদের পাওনা", image: "/IMG20240418145840.jpg" },
  { icon: "😂", title: "The inside joke that never gets old", text: "একে অপরকে সবসময় রোস্ট করা সব সময় রাগানো এটাই আমাদের সবচেয়ে বড় এন্টারটেইনমেন্টের একটা রাস্তা, এইজন্যই আমরা একে অপরের প্রতি bore হয়না", image: "/IMG20240629152247.jpg" },
  { icon: "🩷", title: "Right now", text: "এখন শুধু একটা কথাই বলতে পারি তুমি আমার শরীরের একটা অঙ্গের মতো হয়ে গেছো যেটাকে ছাড়া আমি থাকতেই পারবো না । তোমাকে ছাড়া এক মুহূর্ত ভাবতেও পারি না এখন, সব সময় তোমাকে চাই । এইভাবেই সবসময় তোমার সাথে থাকবো, তোমার যত্ন নেবো, তোমাকে হাসাবো, তোমাকে ভালো রাখার চেষ্টা করবো গো সোনা", image: "/IMG20251102170822.jpg" }
];
